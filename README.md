...
Build: Compiles and publishes the ASP.NET Core application.

Deploy: Deploys the published application to the specified Azure Web App.
...
Other GitHub Actions for Azure
